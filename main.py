...
THERMOGRAPHY_CAPACITY = 1.4

BASE_TIME = datetime(2020, 7, 1, 8, 0) # t = 0
MAX_TIME_STEP = 30 * 60 # [sec]

STATIONS_CONF = {
	'海浜幕張': {'time':13 * 60, 'sd':115}, # [sec]
	'京成幕張': {'time':14 * 60, 'sd':125}, # [sec]
	'幕張': {'time':15 * 60, 'sd':130} # [sec] 
}
...
TRAINS_CONF = [
	...
	},
	{
		...
		'trains':[
			...
			{'arrival_time':datetime(2020, 7, 1, 7, 55), 'nop':110}, # 総武線 中野行 0755着
			{'arrival_time':datetime(2020, 7, 1, 7, 58), 'nop':100}, # 総武線 中野行 0758着
